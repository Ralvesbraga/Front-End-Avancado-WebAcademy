...
INSERT INTO `usuario` VALUES
    (DEFAULT,TRUE,'Administrador','admin','ROLE_ADMIN','admin'),
    (DEFAULT,TRUE,'Daniel','daniel','ROLE_ADMIN','daniel'),
    (DEFAULT,TRUE,'Paulo','paulo','ROLE_ATENDENTE','paulo'),
    (DEFAULT,TRUE,'Limeira','limeira','ROLE_ATENDENTE','limeira');
