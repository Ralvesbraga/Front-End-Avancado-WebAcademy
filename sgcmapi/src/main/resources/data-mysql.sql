...
INSERT INTO `atendimento` (`id`, `data`, `hora`, `status`, `convenio_id`, `paciente_id`, `profissional_id`) VALUES
    (1,'2024-12-19','14:00:00','AGENDADO',1,1,1),
    (2,'2024-12-18','14:30:00','AGENDADO',2,2,2),
    (3,'2024-12-18','14:00:00','AGENDADO',3,3,3),
    (4,'2024-12-19','15:00:00','AGENDADO',1,4,4),
    (5,'2024-12-22','15:00:00','AGENDADO',2,1,1),
    (6,'2024-12-22','16:00:00','AGENDADO',3,2,1),
    (7,'2024-12-21','17:30:00','AGENDADO',1,3,2),
    (8,'2024-12-20','16:30:00','AGENDADO',2,4,2),
    (9,'2024-12-20','15:00:00','AGENDADO',3,5,5),
    (10,'2024-12-21','17:30:00','AGENDADO',1,2,3),
    (11,'2024-12-21','18:00:00','AGENDADO',3,3,1),
    (12,'2024-12-25','17:00:00','AGENDADO',1,3,5),
    (13,'2024-12-25','17:30:00','AGENDADO',1,4,5),
    (14,'2024-12-26','18:00:00','AGENDADO',1,5,5),
    (15,'2024-12-26','18:30:00','AGENDADO',1,1,5),
    (16,'2024-12-28','15:00:00','AGENDADO',1,4,4),
    (17,'2024-12-29','15:00:00','AGENDADO',2,1,1),
    (18,'2024-12-28','16:00:00','AGENDADO',3,2,1),
    (19,'2024-12-29','15:30:00','AGENDADO',1,3,2),
    (20,'2024-12-28','16:30:00','AGENDADO',2,4,2);
...
INSERT INTO `usuario` (`id`, `ativo`, `nome_completo`, `nome_usuario`, `papel`, `senha`) VALUES
    ...
    (4,b'1','Limeira','limeira','ROLE_ATENDENTE','$2a$10$x3e7yFAQ5cN8bD2bZkZ3t.X6IMjHA9o34JmIfuiVVBQfUiGmWnXtG');
